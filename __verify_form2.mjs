...
const modalInfo = await page.evaluate(() => {
  ...
  const dialog = document.querySelector('.departure-dialog');
  return {
...
await page.screenshot({ path: 'C:/Users/RAJ/AppData/Local/Temp/claude/c--6th-sem-travelclientWork/325d435c-9c7a-409b-8afb-20fd8161aa25/scratchpad/departure-form-mobile2.png' });
await browser.close();
