...
async function renderListing(slug) {
  ...
  mount.innerHTML = categoryBanner(category.image||'https://res.cloudinary.com/dq3typk9u/image/upload/v1786542561/travelenfield/hero.jpg', category.title, category.description, category.name||'Trips')
...
async function renderHotels() {
  ...
  mount.innerHTML = categoryBanner('https://res.cloudinary.com/dq3typk9u/image/upload/v1786542562/travelenfield/hotels/hotel-discovery-hero-v2.png', 'Hotels & Handpicked Stays', 'Verified partner hotels across India and beyond with transparent per-night rates, free cancellation and real guest ratings.', 'Hotels')
...
async function renderTrip(slug) {
  ...
  const tripImage=trip.image||'/assetshttps://res.cloudinary.com/dq3typk9u/image/upload/v1786542561/travelenfield/hero.jpg';
