...
function renderAboutPage(){
  ...
  mount.innerHTML=`<div class="about-page about-capture-layout">
    <section class="about-hero about-visual-hero" aria-label="TravelEnfield travel community">
      ...
      <div class="about-hero-inner container"><a class="btn btn-primary about-hero-enquiry" href="/custom-trip">${icon('send')} Enquire Now</a></div>
    </section>
    ...
    <section class="about-story" aria-labelledby="about-story-title"><div class="container about-story-grid"><div class="about-story-index" aria-hidden="true">01</div><div class="about-story-copy"><span class="section-kicker">Our story</span><h2 id="about-story-title">Travel should feel like more than checking places off a list.</h2><p>TravelEnfield started with a simple thought: the best trips happen when the planning is clear, the people feel right and there is room for the unexpected.</p><p>Today, we bring together solo travellers, friends and curious explorers for journeys shaped by local moments, big views and the sort of conversations that outlast the trip.</p><a href="/reviews" class="about-text-link">Meet our travellers ${icon('arrow-right')}</a></div></div></section>
    <section class="about-timeline" aria-labelledby="about-timeline-title"><div class="container"><div class="about-timeline-heading"><span class="section-kicker">The journey so far</span><h2 id="about-timeline-title">Built one shared journey at a time.</h2></div><img src="/journey-img.png" alt="TravelEnfield's journey and milestones" loading="lazy" /></div></section>
    <section class="traveller-love about-reels" aria-labelledby="about-reels-title"><div class="container"><span class="section-kicker">The people behind the memories</span><h2 class="section-title center" id="about-reels-title">Loved by Travellers Across India</h2><p class="section-subtitle">A few real moments from the community that makes every departure special.</p><video class="traveller-love-video" autoplay muted loop playsinline preload="metadata" aria-label="TravelEnfield traveller community highlights"><source src="https://res.cloudinary.com/dq3typk9u/video/upload/v1786868355/travelenfield/socialmedia/new-intro.mp4" type="video/mp4"></video></div></section>
  </div>`;
}
